...
public class SubscriptionController {
    ...
    private HashMap<URI, EventDispatcher> subscribedEndpoints = new HashMap<>();
    private HashMap<URI, HashSet<String>> subscriptions = new HashMap<>();
    ...
    public boolean subscribeEndpoint(URI endpoint, Selector selector) {
        ...
        if (!subscriptions.get(endpoint).contains(channel)) {
            ...
            for (URI url : subscriptions.keySet()) {
