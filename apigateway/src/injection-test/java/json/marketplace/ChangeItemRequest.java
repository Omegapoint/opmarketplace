...
public class ChangeItemRequest {
    ...
    private Result id(List<String> values, MockMvc mockMvc) throws Exception {
        ...
        for (String s : values) {
            MvcResult mvcResult = Requests.changeItem(s, "valid", "valid", "1", "1", mockMvc)
                    .andReturn();
    ...
    private Result title(List<String> values, MockMvc mockMvc) throws Exception {
        Result res = new Result(values.size());
        for (String s : values) {
            MvcResult mvcResult = Requests.changeItem("38400000-8cf0-11bd-b23e-10b96e4ef00d", s, "valid", "1", "1", mockMvc)
                    .andReturn();
            res.registerResult(mvcResult, s);
        }
        return res;
    ...
    private Result description(List<String> values, MockMvc mockMvc) throws Exception {
        Result res = new Result(values.size());
        for (String s : values) {
            MvcResult mvcResult = Requests.changeItem("38400000-8cf0-11bd-b23e-10b96e4ef00d", "valid", s, "1", "1", mockMvc)
                    .andReturn();
            res.registerResult(mvcResult, s);
        }
        return res;
    ...
    private Result price(List<String> values, MockMvc mockMvc) throws Exception {
        ...
        for (String s : values) {
            try {
                MvcResult mvcResult = Requests.changeItem("38400000-8cf0-11bd-b23e-10b96e4ef00d", "valid", "valid", s, "1", mockMvc)
                        .andReturn();
                res.registerResult(mvcResult, s);
    ...
    private Result supply(List<String> values, MockMvc mockMvc) throws Exception {
        ...
        for (String s : values) {
            try {
                MvcResult mvcResult = Requests.changeItem("38400000-8cf0-11bd-b23e-10b96e4ef00d", "valid", "valid", "1", s, mockMvc)
                        .andReturn();
                res.registerResult(mvcResult, s);
            } catch (JsonParseException e){
                res.registerBlock();
